...
starring this repository if you found it useful! ⭐️

## Installation

To integrate this action into your repository, you'll need to start by creating
a GitHub Action workflow file. In your repository, navigate to/create
...
You will need to generate a Personal Access Token (PAT) in your
...
your repository. They will be located at an address like
`https://github.com/<user>/<repo>/settings/secrets/actions`. There, create a new
repository secret, name it `PAT`, and paste the generated token in the body!
...
- **Permissions Error:** Verify that your PAT has the necessary scopes (repo and
  read:user).
